...
require dirname(__FILE__).'/include/gettextwrapper.inc.php';
require dirname(__FILE__).'/include/js.inc.php';
require dirname(__FILE__).'/include/locales.inc.php';
...
require dirname(__FILE__).'/include/translateDefines.inc.php';
...
$availableJScripts = [
	...
	'echarts.min.js' => 'vendors/',
	'echarts-all-map.js' => 'vendors/',
	// classes
	'class.bbcode.js' => '',
	'class.calendar.js' => '',
	'class.cdate.js' => '',
